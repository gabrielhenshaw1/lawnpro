...
export default function Sidebar({ onNavigate, currentPage }) {
  const navItems = [
    ...
    { icon: <IconRequests />, name: 'Requests' },
    { icon: <IconMeasure />, name: 'Estimate Tool' }, // <-- NEW
    { icon: <IconCalendar />, name: 'Schedule' },
    { icon: <IconClients />, name: 'Clients' },
    { icon: <IconBilling />, name: 'Billing' },
  ];
  return (
            ...
            return (
              <li key={item.name}>
                <button
                  ...
                  className={`flex items-center gap-4 p-3 rounded-lg w-full text-left transition-colors mb-1
